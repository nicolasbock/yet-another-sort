% yet-another-sort(SECTION) | User Commands
%
% "August 18 2023"
...
yet-another-sort - program to do something

# SYNOPSIS

**yet-another-sort** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**yet-another-sort** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **yet-another-sort** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**yet-another-sort** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    yet-another-sort. See **foo.conf**(5) for further details.
...
**yet-another-sort** provides some return codes, that can be used in scripts:
...
Nicolas Bock <nbock@rubberducky.virtual>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Nicolas Bock
